            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_kemu3"
                        ...
                        <script>
                            $(".class_kemu3").val($(".class_kemu3").attr("data-value"));
                        </script>
                    </div>
            ...
            <div class="list-table">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            Map mapkemu3 = new CommDAO().find("SELECT kemumingcheng,id FROM kemu where id='" + map.get("kemu") + "'"); %>
                            <%= mapkemu3.get("kemumingcheng") %>
                        </td>
                        <td><%= map.get("chengji") %>
                        </td>
