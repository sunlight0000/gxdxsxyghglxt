 ...
 <% Map readMap = Query.make("cepingtiku").where("id", request.getParameter("id")).find(); %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加测评结果:</div>
            <div class="panel-body">
                <form action="cepingjieguo.jsp?a=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入试题题目" style="width: 250px" id="shititimu" name="shititimu" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入类型" style="width: 250px" id="leixing" name="leixing" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">得分</label>
                            <div class="col-sm-10">
                                <input
                                    type="number"
                                    class="form-control"
