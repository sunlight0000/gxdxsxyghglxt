            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="width: 80px" name="zongdeifen_start"
                               value="<%= request.getParameter("zongdeifen_start") !=null ? request.getParameter("zongdeifen_start") : "" %>"/>-
                        <input type="text" class="form-control" style="width: 80px" name="zongdeifen_end"
                               value="<%= request.getParameter("zongdeifen_end") !=null ? request.getParameter("zongdeifen_end") : "" %>"/>
                    </div>
                    <div class="form-group">
                        测评学生

                        <input type="text" class="form-control" style="" name="cepingxuesheng"
                               value="<%= request.getParameter("cepingxuesheng") !=null ? request.getParameter("cepingxuesheng") : "" %>"/>
                    </div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td align="center">
                            ...
                            <a href="cepingchengji.jsp?a=delete&id=<%= map.get("id") %>"
