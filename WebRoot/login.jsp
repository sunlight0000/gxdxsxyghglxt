            ...
            <div class="container">
                <div class="row align-items-center py-5">
                    ...
                    <div class="col-lg-5 px-lg-4">
                        <h2 class="text-base text-primary text-uppercase mb-4">高校大学生学业规划管理系统</h2>
                        <p class="text-muted">欢迎使用高校大学生学业规划管理系统后台管理系统</p>
                        <form id="loginForm" action="login?ac=adminlogin&a=a" class="mt-4" method="post">
                            ...
                            <div class="form-group mb-4">
                                <input type="password" name="pwd" placeholder="密码" class="form-control border-0 shadow form-control-lg text-violet" />
                            </div>
                            <div class="form-group mb-4">
                ...
                <p class="mt-5 mb-0 text-gray-400 text-center">Copyright &copy; 高校大学生学业规划管理系统</p>
            </div>
        </div>
        <!-- JavaScript files-->
