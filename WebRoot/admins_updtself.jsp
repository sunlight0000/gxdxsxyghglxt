            ...
            <div class="panel-body">
                <form action="admins.jsp?a=update" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">权限<span
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">帐号<span
                                    style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <input
                                        type="text"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">联系方式<span
                                    style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <input
                                        type="text"
