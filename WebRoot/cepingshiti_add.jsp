...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加测评试题:</div>
            <div class="panel-body">
                <form action="cepingshiti.jsp?a=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->

                    <input type="hidden" name="cepingtikuid"
                           value="<%= request.getParameter("id") !=null ? request.getParameter("id") : "" %>"/>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">测评编号</label>
                            <div class="col-sm-10"><%= readMap.get("cepingbianhao") %><input type="hidden"
                                                                                             id="cepingbianhao"
                                                                                             name="cepingbianhao"
                                                                                             value="<%= Info.html(readMap.get("cepingbianhao")) %>"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10"><%= readMap.get("cepingmingcheng") %><input type="hidden"
                                                                                               id="cepingmingcheng"
                                                                                               name="cepingmingcheng"
                                                                                               value="<%= Info.html(readMap.get("cepingmingcheng")) %>"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10"><%= readMap.get("faburen") %><input type="hidden" id="faburen"
                                                                                       name="faburen"
                                                                                       value="<%= Info.html(readMap.get("faburen")) %>"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">试题题目<span
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">类型<span
                                    style="color: red">*</span></label>
                            <div class="col-sm-10">
                                <select
