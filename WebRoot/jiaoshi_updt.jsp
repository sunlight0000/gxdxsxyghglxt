                ...
                <form action="jiaoshi.jsp?a=update" method="post" name="form1" id="form1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="factory/checkno.jsp?checktype=update&id=<%= mmm.get("id") %>&table=jiaoshi&col=gonghao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_xingbie10"
                                ...
                                <script>
                                    $(".class_xingbie10").val($(".class_xingbie10").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
