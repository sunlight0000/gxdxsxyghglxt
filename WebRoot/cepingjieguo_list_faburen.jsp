            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="cepingren" value="<%= request.getParameter("cepingren") !=null ? request.getParameter("cepingren") : "" %>" />
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td align="center">
                                ...
                                <a href="cepingjieguo.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        <%} %>
