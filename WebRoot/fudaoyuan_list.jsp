...
<div style="padding: 10px" class="admin-content">
    ...
    List<Map> list = Query.make("fudaoyuan").where(where).order(orderby + " " + sort).page(15);
    %>


    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> 辅导员 </span>
            <span>列表</span>
        </div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td align="center">
                                <a href="fudaoyuan_detail.jsp?id=<%= map.get("id") %>">详情</a>

                                <a href="fudaoyuan_updt.jsp?id=<%= map.get("id") %>">编辑</a>

                                <a href="fudaoyuan.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        <%} %>
