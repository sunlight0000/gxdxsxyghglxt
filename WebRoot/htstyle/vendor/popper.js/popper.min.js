...
function x(e, t, o, n) {
    return Math.max(
        ...
        o[`offset${e}`],
        o[`scroll${e}`],
        h(10) ? o[`offset${e}`] + n[`margin${"Height" === e ? "Top" : "Left"}`] + n[`margin${"Height" === e ? "Bottom" : "Right"}`] : 0
    );
}
function v() {
...
function z(e, t, o, n) {
    (o.updateBound = n), q(e).addEventListener("resize", o.updateBound, { passive: !0 });
    const i = a(e);
...
function J(e, t) {
    Object.keys(t).forEach((o) => {
        let n = "";
        -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(o) && Q(t[o]) && (n = "px"), (e.style[o] = t[o] + n);
    });
}
function Z(e, t) {
...
function te(e, t) {
    ...
    const s = void 0 === d ? t.gpuAcceleration : d,
        ...
        g = K("transform");
    let b, w;
    if (((w = "bottom" == h ? -a.height + m.bottom : m.top), (b = "right" == u ? -a.width + m.right : m.left), s && g))
...
function ne(e, t) {
    ...
    return (w = Math.max(Math.min(i[d] - h, w), 0)), (e.arrowElement = o), (e.offsets.arrow = { [a]: Math.round(w), [l]: "" }), e;
}
function ie(e) {
...
function le(e, t, o, n) {
    ...
    if ("vh" === d || "vw" === d) {
        let e;
        return (
            (e = "vh" === d ? i(document.documentElement.clientHeight, window.innerHeight || 0) : i(document.documentElement.clientWidth, window.innerWidth || 0)), (e / 100) * p
        );
    }
    return p;
}
    ...
    return (
        (f = f.map((e, n) => {
            ...
            return e
                .reduce(
                    (e, t) =>
                        "" === e[e.length - 1] && -1 !== ["+", "-"].indexOf(t) ? ((e[e.length - 1] = t), (p = !0), e) : p ? ((e[e.length - 1] += t), (p = !1), e) : e.concat(t),
                    []
                )
                .map((e) => le(e, i, t, o));
        })),
...
var we = {
        ...
        preventOverflow: { order: 300, enabled: !0, fn: ce, priority: ["left", "right", "top", "bottom"], padding: 5, boundariesElement: "scrollParent" },
