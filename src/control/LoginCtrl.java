    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ac.equals("login")) {
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                String sql1 = "";
                if (utype.equals("教师")) {
                    sql1 = "select * from jiaoshi where gonghao='" + username + "' and mima='" + password + "' ";
                }
                if (utype.equals("辅导员")) {
                    sql1 = "select * from fudaoyuan where gonghao='" + username + "' and mima='" + password + "' ";
                }
                if (utype.equals("学生")) {
        ...
        if (ac.equals("adminuppass")) {
            ...
            if (cx.equals("教师")) {
                biao = "jiaoshi";
                m = Query.make(biao).where("gonghao", username).where("mima", olduserpass).find();
                // dao.getmaps("gonghao", (String) request.getSession().getAttribute("username"), "jiaoshi");
            }
            if (cx.equals("辅导员")) {
                biao = "fudaoyuan";
                m = Query.make(biao).where("gonghao", username).where("mima", olduserpass).find();
                // dao.getmaps("gonghao", (String) request.getSession().getAttribute("username"), "fudaoyuan");
            }
            if (cx.equals("学生")) {
                biao = "xuesheng";
            ...
            if (m == null || m.isEmpty()) {
                ...
                if (cx.equals("教师")) {
                    sql = "UPDATE jiaoshi SET mima='" + userpass + "' WHERE gonghao='" + username + "'";
                }
                if (cx.equals("辅导员")) {
                    sql = "UPDATE fudaoyuan SET mima='" + userpass + "' WHERE gonghao='" + username + "'";
                }
                if (cx.equals("学生")) {
