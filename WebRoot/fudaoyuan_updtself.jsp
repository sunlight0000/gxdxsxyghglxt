...
<div style="padding: 10px" class="admin-content">
    ...
    <%return;
     ...
     HashMap mmm = new CommDAO().getmaps("gonghao", (String) request.getSession().getAttribute("username"), "fudaoyuan");
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑辅导员:</div>
            <div class="panel-body">
                <form action="fudaoyuan.jsp?a=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="factory/checkno.jsp?checktype=update&id=<%= mmm.get("id") %>&table=fudaoyuan&col=gonghao"
                                    data-msg-remote="内容重复了"
                                    id="gonghao"
                                    name="gonghao"
                                    value="<%= Info.html(mmm.get("gonghao")) %>"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="biyeyuanxiao"
                                    name="biyeyuanxiao"
                                    value="<%= Info.html(mmm.get("biyeyuanxiao")) %>"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="youxiang"
                                    name="youxiang"
                                    value="<%= Info.html(mmm.get("youxiang")) %>"
                                />
                            </div>
                        </div>
                    </div>
